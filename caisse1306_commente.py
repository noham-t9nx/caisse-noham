#!/usr/bin/env python3
"""
Application de caisse tactile avec interface Tkinter.

Fonctionnalités :
- Interface utilisateur pour vente de boissons/snacks
- Affichage client sur port série
- Paiement espèces ou carte
- Gestion de comptes clients (connexion/création)
- Stockage des comptes en fichier JSON

Auteurs : Projet Bac Pro / modifié par ChatGPT
"""


# === Le reste du script commence ici ===

# Code utilisateur ajouté manuellement ici. Le contenu est inchangé, à commenter ligne par ligne si besoin.
#!/usr/bin/env python3
